...
tracts19 <- 
  ...
  st_transform('EPSG:3498') %>%      # WAS 3498 
...
ELocations <- st_read("/Users/Aidan/Desktop/code2/LARPFINAL/Public_Elementary_Schools.geojson") %>%
  st_transform('EPSG:3498')  # ALL WERE 3498
...
SocialTracts <- SocialTracts %>%
  mutate(EducationQuantile = ntile(SocialTracts$Education.Pctl,5),
         IncomeQuantile = ntile(SocialTracts$MedHHInc,5),
...
# ONLY CAN USE THIS FEATURE IF 3498 
...
GreenCentroids <- GreenSpace %>%
  ...
  st_transform('EPSG:3498') %>%   # was 3498
  mutate(Name = PARK_NAME) %>%
  dplyr::select(OBJECTID,ADDRESS,CITY,PHONES,AGNCY_WEB,ZIP,RPT_ACRES,geometry,Name)
# was just zip rpt_acres, geometry and Name 
...
featured_tc <- grouped_tc %>%
  ...
  dplyr::select(CT10, AvgTCpctDiff, PEpctDiff, EpctTC, PpctIP, PpctVG, PpctTC)
...
PhysVulScore <- QuantileTracts %>%
  mutate(PhysVulScore = ((HospitalDistQuantile + EmergencyDistQuantile + CoolingDistQuantile + ParkDistQuantile + PoolDistQuantile + ForestDistQuantile) / 6) * 0.20 + ((HospitalCountQuantile + EmergencyCountQuantile + CoolingCountQuantile + ParkCountQuantile + PoolCountQuantile) / 5) * 0.20 + ((PM2.5Quantile + DieselPMQuantile + OzoneQuantile) / 3) * 0.20 + ((GreenSpaceQuantile + ExistingTCQuantile + PdiffETCQuantile) / 3) * 0.20 + ((HisProjTDiffQuantile + HisProjEventDiffQuantile + HisProjDurDiffQuantile) / 3) * 0.20)
...
########### Make raw feature maps 

# first, census tract feature maps  
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(MedHHInc)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"MedHHInc"),
                    name="Median Household Income\n(Quintile Breaks)")+
  labs(title="Median Household Income", 
       subtitle="Los Angeles, CA", 
       caption="Figure 1") +
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(MedianAge)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"MedianAge"),
                    name="Median Age\n(Quintile Breaks)")+
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(pctNonWhite)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"pctNonWhite",rnd=F),
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(pctPoverty)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"pctPoverty",rnd=F),
                    name="Percent in Poverty\n(Quintile Breaks)")+
  labs(title="Percent in Poverty", 
       subtitle="Los Angeles, CA", 
       caption="Figure 4") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(Unemployment.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"Unemployment.Pctl",rnd=F),
                    name="Percent Unemployed\n(Quintile Breaks)")+
  labs(title="Percent Unemployed", 
       subtitle="Los Angeles, CA", 
       caption="Figure 5") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(pctCarless)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"pctCarless",rnd=F),
                    name="Percent without car access\n(Quintile Breaks)")+
  labs(title="Percent without car access", 
       subtitle="Los Angeles, CA", 
       caption="Figure 6") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(Education.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"Education.Pctl",rnd=F),
                    name="Percent over 25 w/o high school diploma\n(Quintile Breaks)")+
  labs(title="Percent over 25 w/o high school diploma", 
       subtitle="Los Angeles, CA", 
       caption="Figure 7") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(Linguistic.Isolation.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"Linguistic.Isolation.Pctl",rnd=F),
                    name="Percent limited-English\n(Quintile Breaks)")+
  labs(title="Percent limited-English", 
       subtitle="Los Angeles, CA", 
       caption="Figure 8") +
  mapTheme()
...
# now, different spatial features 
...
ggplot() + 
  ...
  geom_sf(data=Emergency_sf, 
          show.legend = "point", size= 2) +
  labs(title="Emergency Preparedness Locations", 
       subtitle="Los Angeles, CA", 
       caption="Figure 10") +
  mapTheme()
...
ggplot() + 
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=Pool_sf, 
          show.legend = "point", size= 2) +
  labs(title="Public Pools and Sprayground Locations", 
       subtitle="Los Angeles, CA", 
       caption="Figure 11") +
  mapTheme()
...
ggplot() + 
  ...
  geom_sf(data=CoolingLocations, 
          show.legend = "point", size= 2) +
  labs(title="Cooling Center Locations", 
       subtitle="Los Angeles, CA", 
       caption="Figure 12") +
  mapTheme()
...
ggplot() + 
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=GreenCentroids, 
          show.legend = "point", size= 2) +
  labs(title="Public Parks and Green Space Locations", 
       subtitle="Los Angeles, CA", 
       caption="Figure 13") +
  mapTheme()
...
ggplot() + 
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=GreenSpace) +
  labs(title="Public Parks and Green Space Layer", 
       subtitle="Los Angeles, CA", 
       caption="Figure 14") +
  mapTheme()
...
# red-lined districts 
RedLined <- st_read("/Users/Aidan/Desktop/code2/LARPFINAL/CALosAngeles1939.geojson") %>%
  st_transform('EPSG:3498') %>%
...
ggplot() + 
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=RedLined) +
  labs(title="Red-lined Districts Layer", 
       subtitle="Los Angeles, CA", 
       caption="Figure 15") +
  mapTheme()
...
ggplot() + 
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=AngelesForest, col="green") +
  labs(title="Angeles Forest", 
       subtitle="Los Angeles, CA", 
       caption="Figure 24") +
  mapTheme()
...
# physical vulnerability features 
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(proj_avg_tmax)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"proj_avg_tmax"),
                    name="Max Projected Temperature\n(Quintile Breaks)")+
  labs(title="Max Projected Temperature", 
       subtitle="Los Angeles, CA", 
       caption="Figure 16") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(proj_ann_num_events)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"proj_ann_num_events"),
                    name="# of Heat Events\n(Quintile Breaks)")+
  labs(title="Projected # of Heat Events/year", 
       subtitle="Los Angeles, CA", 
       caption="Figure 17") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(proj_avg_duration)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"proj_avg_duration"),
                    name="Projected Duration of Heat Events\n(Quintile Breaks)")+
  labs(title="Projected Duration of Heat Events (days)", 
       subtitle="Los Angeles, CA", 
       caption="Figure 18") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(pctGreenSpace)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"pctGreenSpace",rnd=F),
                    name="Percent Green Space\n(Quintile Breaks)")+
  labs(title="Percent Public-Access Green Space", 
       subtitle="Los Angeles, CA", 
       caption="Figure 19") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(nearestParkDist)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"nearestParkDist"),
                    name="Distance\n(Quintile Breaks)")+
  labs(title="Distance to nearest public green space", 
       subtitle="Los Angeles, CA", 
       caption="Figure 20") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(EpctTC)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"EpctTC",rnd=F),
                    name="Percent Tree Canopy\n(Quintile Breaks)")+
  labs(title="Existing Percent Tree Canopy", 
       subtitle="Los Angeles, CA", 
       caption="Figure 21") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(PpctTC)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"PpctTC",rnd=F),
                    name="Percent Tree Canopy\n(Quintile Breaks)")+
  labs(title="Possible Percent Tree Canopy", 
       subtitle="Los Angeles, CA", 
       caption="Figure 22") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(PEpctDiff)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"PEpctDiff",rnd=F),
                    name="Percent Tree Canopy\n(Quintile Breaks)")+
  labs(title="Difference between Existing and Possible Tree Canopy Percent", 
       subtitle="Los Angeles, CA", 
       caption="Figure 23") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(Asthma.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"Asthma.Pctl",rnd=F),
                    name="Percent\n(Quintile Breaks)")+
  labs(title="Percent of people with Asthma", 
       subtitle="Los Angeles, CA", 
       caption="Figure 25") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(Cardiovascular.Disease.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"Cardiovascular.Disease.Pctl",rnd=F),
                    name="Percent\n(Quintile Breaks)")+
  labs(title="Percent of people with Cardiovascular Disease", 
       subtitle="Los Angeles, CA", 
       caption="Figure 26") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(Low.Birth.Weight.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"Low.Birth.Weight.Pctl",rnd=F),
                    name="Percent\n(Quintile Breaks)")+
  labs(title="Percent of people born with low birth weight", 
       subtitle="Los Angeles, CA", 
       caption="Figure 27") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(PM2.5.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"PM2.5.Pctl",rnd=F),
                    name="Percent\n(Quintile Breaks)")+
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(Diesel.PM.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"Diesel.PM.Pctl",rnd=F),
                    name="Percent\n(Quintile Breaks)")+
  labs(title="Diesel PM concentration", 
       subtitle="Los Angeles, CA", 
       caption="Figure 29") +
  mapTheme()
...
ggplot() +
  geom_sf(data=st_union(TotalVulScore)) +
  geom_sf(data=TotalVulScore,aes(fill=q5(Ozone.Pctl)))+
  scale_fill_manual(values=palette5,
                    labels=qBr(TotalVulScore,"Ozone.Pctl",rnd=F),
                    name="Percent\n(Quintile Breaks)")+
...
st_write(H_sf, "/Users/Aidan/Desktop/code2/LARPFINAL/newesthospitals.geojson")
st_write(Emergency_sf, "/Users/Aidan/Desktop/code2/LARPFINAL/newestemergencyprep.geojson")
st_write(CoolingLocations, "/Users/Aidan/Desktop/code2/LARPFINAL/newestcoolingcenters.geojson")
st_write(Pool_sf, "/Users/Aidan/Desktop/code2/LARPFINAL/newestpublicpools.geojson")
st_write(GreenCentroids, "/Users/Aidan/Desktop/code2/LARPFINAL/newesterparksandgs.geojson")


GreenCentroids <- GreenCentroids %>%
  mutate(in_bounds = lengths(st_within(GreenCentroids,TotalVulScore))) %>%
  filter(in_bounds == 1) %>%
  filter(Name != "Hollywood Bowl") %>%
  dplyr::select(OBJECTID,Name,RPT_ACRES,ADDRESS,CITY,ZIP,PHONES,AGNCY_WEB)

GreenCentroids$PHONES <- GreenCentroids$PHONES %>% replace_na('none')

Emergency_sf <- Emergency_sf %>%
  mutate(in_bounds = lengths(st_within(Emergency_sf,TotalVulScore))) %>%
  filter(in_bounds == 1) %>%
...
#filteredTracts = st_filter(tracts19na, LosAngelesBoundary, .pred = st_intersects)
H_sf <- H_sf %>%
  mutate(in_bounds = lengths(st_within(H_sf,TotalVulScore))) %>%
  filter(in_bounds == 1) %>%
  dplyr::select(phones,Name,zip,addrln1,hours,post_id,link,url,cat1,cat2) 

CoolingLocations <- CoolingLocations %>%
  mutate(in_bounds = lengths(st_within(CoolingLocations,TotalVulScore))) %>%
  filter(in_bounds == 1) %>%
  dplyr::select(OBJECTID,Name,addrln1,hours,phones,url,zip,link,latitude,longitude)

Pool_sf <- Pool_sf %>%
  mutate(in_bounds = lengths(st_within(Pool_sf,TotalVulScore))) %>%
  filter(in_bounds == 1) %>%
  dplyr::select(OBJECTID,Name,addrln1,hours,phones,url,zip,link,latitude,longitude)


# Split dataframe into social, phys, and total 
CompleteSocial <- TotalVulScore %>% 
  dplyr::select(Tract_N,Education.Pctl,Poverty.Pctl,Unemployment.Pctl,pctSinglePar,pctUnder5,pctOver65,pctMENTAL,pctPHY,pctNonWhite,pctImmigrants,pctPriorImmigrants,Linguistic.Isolation.Pctl,Asthma.Pctl,Low.Birth.Weight.Pctl,Cardiovascular.Disease.Pctl,pctCarless,pctPubTrans,pctHomeless,pctInstit,Housing.Burden.Pctl,SocVulScore,SocVulScoreQuantile)

# filter to neat features 
BOYSocial <- CompleteSocial %>%
  mutate(Tract = Tract_N,
         "Percent Poverty" = round(Poverty.Pctl, digits=2),
         "Percent Unemployed" = round(Unemployment.Pctl, digits=2),
         "Percent Non-White" = round(pctNonWhite, digits=2),
         Percent_Over25_Without_HighSchool_Diploma = round(Education.Pctl, digits=2),
         Percent_Limited_English = round(Linguistic.Isolation.Pctl, digits=2),
         Percent_Over_65 = round(pctOver65, digits=2),
         Percent_Under_5 = round(pctUnder5, digits=2),
         Percent_Homeless = round(pctHomeless, digits=3),
         Percent_Housing_Burden = round(Housing.Burden.Pctl, digits=2),
         Percent_Single_Parent = round(pctSinglePar, digits=2),
         Percent_Immigrant = round(pctImmigrants, digits=2),
         Percent_w_Cardiovascular_Disease = round(Cardiovascular.Disease.Pctl,digits=2),
         "Percent with Asthma" = round(Asthma.Pctl, digits=2),
         Percent_Carless = round(pctCarless, digits=3),
         "Social Vulnerability Score" = round(SocVulScore, digits=2),
         "Social Vulnerability Score Quantile" = SocVulScoreQuantile,
         "City Median Social Vulnerability Score" = format(round(median(SocVulScore),7),n_small=7)) %>%
  dplyr::select(Tract,"Percent Poverty","Percent Unemployed","Percent Non-White","Percent with Asthma","Social Vulnerability Score","Social Vulnerability Score Quantile","City Median Social Vulnerability Score")


CompletePhysical <- TotalVulScore %>%
  dplyr::select(Tract_N,nearestHospitalDist,nearestEmergencyPrepDist,nearestCoolingDist,nearestParkDist,nearestPoolDist,HospitalCounts,EmergencyPrepCounts,CoolingStationCounts,ParkCounts,PoolCounts,PM2.5.Pctl,Diesel.PM.Pctl,Ozone.Pctl,pctGreenSpace,HisProjTDiff,HisProjEventDiff,HisProjDurDiff,EpctTC,PpctTC,PEpctDiff,AvgTCpctDiff,PhysVulScore,PhysVulScoreQuantile)

#filter to neat features 
BOYPhysical <- CompletePhysical %>%
  mutate(Percent_PM2.5 = round(PM2.5.Pctl, digits=2),
         Resource_Count = HospitalCounts+ParkCounts+PoolCounts+CoolingStationCounts+EmergencyPrepCounts,
         Percent_Ozone = round(Ozone.Pctl, digits=2),
         Percent_GreenSpace = round(pctGreenSpace, digits=3),
         Percent_Existing_TreeCanopy = round(EpctTC, digits=2),
         Percent_Possible_TreeCanopy = round(PpctTC, digits=2),
         Percent_Discrepancy_TreeCanopy = round(PEpctDiff, digits=2),
         Distance_to_Nearest_Resource = round(nearestResource, digits=3),
         Projected_vs_Historical_Temperature_Difference = HisProjTDiff,
         Projected_vs_Historical_Event_Count_Difference = HisProjEventDiff,
         Physical_Vulnerability_Score = round(PhysVulScore, digits=2),
         Physical_Vulnerability_Score_Quantile = PhysVulScoreQuantile,
         City_Median_Physical_Vulnerability_Score = format(round(median(PhysVulScore),2),n_small=2)) %>%
  dplyr::select(Tract_N,Distance_to_Nearest_Resource,Resource_Count,Percent_GreenSpace,Projected_vs_Historical_Temperature_Difference,Percent_Existing_TreeCanopy,Physical_Vulnerability_Score,Physical_Vulnerability_Score_Quantile,City_Median_Physical_Vulnerability_Score)

CRAPPhysical <- BOYPhysical %>%
  mutate("Distance to Nearest Resource" = Distance_to_Nearest_Resource,
         "Resource Count" = Resource_Count,
         "Percent Greenspace" = Percent_GreenSpace,
         "Projected/Historical Temperature Difference" = Projected_vs_Historical_Temperature_Difference,
         "Percent Tree Canopy" = Percent_Existing_TreeCanopy,
         "Physical Vulnerability Score" = Physical_Vulnerability_Score,
         "Physical Vulnerability Score Quantile" = Physical_Vulnerability_Score_Quantile,
         "City Median Physical Vulnerability Score" = City_Median_Physical_Vulnerability_Score,
         Tract = Tract_N) %>%
  dplyr::select(Tract,"Distance to Nearest Resource","Resource Count","Percent Greenspace","Projected/Historical Temperature Difference","Percent Tree Canopy","Physical Vulnerability Score","Physical Vulnerability Score Quantile","City Median Physical Vulnerability Score")


CompleteOverall <- TotalVulScore %>%
  mutate(Tract = Tract_N,
         "Social Vulnerability Score" = round(SocVulScore, digits=2),
         "Physical Vulnerability Score" = round(PhysVulScore, digits=2),
         "Total Vulnerability Score" = round(TotalVulScore, digits=2),
         "Social Vulnerability Score Quantile" = SocVulScoreQuantile,
         "Physical Vulnerability Score Quantile" = PhysVulScoreQuantile,
         "Total Vulnerability Score Quantile" = TotalVulScoreQuantile,
         "City Median Total Vulnerability Score" = format(round(median(TotalVulScore),2),n_small=2)) %>%
  dplyr::select(Tract,"Social Vulnerability Score","Physical Vulnerability Score","Total Vulnerability Score","Social Vulnerability Score Quantile","Physical Vulnerability Score Quantile","Total Vulnerability Score Quantile","City Median Total Vulnerability Score")




st_write(BOYSocial, "/Users/Aidan/Desktop/code2/LARPFINAL/newestsocialvulnerability.geojson")
st_write(CRAPPhysical, "/Users/Aidan/Desktop/code2/LARPFINAL/newestphysicalvulnerability.geojson")
st_write(CompleteOverall, "/Users/Aidan/Desktop/code2/LARPFINAL/newestoverallvulnerability.geojson")


FilteredPhysical <- CompletePhysical %>%
  dplyr::select(nearestCoolingDist,nearestEmergencyPrepDist,nearestHospitalDist,nearestParkDist,nearestPoolDist,geometry) %>%
  mutate(nearestResource = pmin(CompletePhysical$nearestHospitalDist,CompletePhysical$nearestCoolingDist,CompletePhysical$nearestEmergencyPrepDist,CompletePhysical$nearestParkDist,CompletePhysical$nearestPoolDist))

CompletePhysical <- CompletePhysical %>%
  mutate(nearestResource = FilteredPhysical$nearestResource)

MostVulnerable <- TotalVulScore %>%
  filter(Tract_N==602801)